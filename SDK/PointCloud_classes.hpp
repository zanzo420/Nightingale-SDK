...
{
public:
	uint8                                        Pad_3D99[0x238];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3D9B[0x98];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3DA7[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3DA9[0x30];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3DB2[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3DC2[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TSet<class UPointCloudView*>                 ChildViews;                                        // 0x60(0x50)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                        Pad_3DC3[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
