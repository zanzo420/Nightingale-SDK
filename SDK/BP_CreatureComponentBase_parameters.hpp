...
struct UBP_CreatureComponentBase_C_ExecuteUbergraph_BP_CreatureComponentBase_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5AE3[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_HasAuthority_ReturnValue_1;               // 0x30(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsServer_ReturnValue_1;                   // 0x31(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5AE6[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
