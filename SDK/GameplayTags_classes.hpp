...
public:
	...
	void UpdateTagContainerWithTagQuery(class UObject* Obj, struct FGameplayTagQuery& GameplayTagQuery, struct FGameplayTagContainer* TagContainer);
...
public:
	...
	uint8                                        Pad_2D21[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2D29[0x160];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	TMap<class FName, struct FGameplayTagSource> TagSources;                                        // 0x188(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_2D2A[0xB0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
