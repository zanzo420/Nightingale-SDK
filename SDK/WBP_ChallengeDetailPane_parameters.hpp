...
public:
	...
	uint8                                        Pad_7882[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        Temp_int_Array_Index_Variable;                     // 0x4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Not_PreBool_ReturnValue;                  // 0x8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_7883[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7884[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7885[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7886[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class UWBP_ChallengeDetailPane_ConditionEntry_C* CallFunc_Create_ReturnValue;                       // 0x18(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_788A[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	int64                                        CallFunc_Conv_IntToInt64_ReturnValue_1;            // 0x150(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData_2;            // 0x158(0x50)(HasGetValueTypeHash)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData_3;            // 0x1A8(0x50)(HasGetValueTypeHash)
	...
	int64                                        CallFunc_Conv_IntToInt64_ReturnValue_2;            // 0x220(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData_4;            // 0x228(0x50)(HasGetValueTypeHash)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array_4;                          // 0x278(0x10)(ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue_4;                     // 0x288(0x18)(None)
	class FText                                  Temp_text_Variable;                                // 0x2A0(0x18)(ConstParm)
};
...
public:
	...
	uint8                                        Pad_789C[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FUIGroupInfo                          CallFunc_GetGroupInfo_ReturnValue;                 // 0x98(0x20)(ConstParm)
	...
	TArray<class URewardBehaviour*>              CallFunc_GetRewards_ReturnValue;                   // 0x118(0x10)(ConstParm, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue_1;                     // 0x128(0x18)(None)
	class URewardBehaviour*                      CallFunc_Array_Get_Item;                           // 0x140(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class IChallengeRewardPresentation> CallFunc_GetChallengeRewardPresentationForReward_Presentation; // 0x148(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	bool                                         CallFunc_GetChallengeRewardPresentationForReward_ReturnValue; // 0x158(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_789D[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        CallFunc_Array_Length_ReturnValue;                 // 0x15C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UObject*                               CallFunc_Conv_InterfaceToObject_ReturnValue;       // 0x160(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  CallFunc_GetDescription_ReturnValue;               // 0x170(0x18)(None)
	class FText                                  CallFunc_GetTitle_ReturnValue;                     // 0x188(0x18)(None)
...
public:
	...
	class FString                                CallFunc_Map_Find_Value;                           // 0xB0(0x10)(ZeroConstructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_78B2[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
