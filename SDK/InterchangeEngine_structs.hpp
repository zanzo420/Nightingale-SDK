...
{
public:
	uint8                                        Pad_4B8C[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_4B8E[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4B8F[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4B90[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4B91[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
