...
public:
	...
	uint8                                        Pad_90C3[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_90C5[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_90C7[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_CraftInProgress           CallFunc_Array_Get_Item;                           // 0x140(0xD8)(HasGetValueTypeHash)
	uint8                                        Pad_90C8[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_90CD[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_90D2[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
