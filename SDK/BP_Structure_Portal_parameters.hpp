...
public:
	bool                                         IsValid;                                           // 0x0(0x1)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A76A[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                ID;                                                // 0x8(0x10)(Parm, OutParm, ZeroConstructor, HasGetValueTypeHash)
...
public:
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A770[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A771[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A772[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A774[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
