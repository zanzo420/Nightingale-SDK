...
public:
	...
	uint8                                        Pad_4EF0[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_CraftInProgress           CraftingData;                                      // 0x10(0xD8)(Parm, OutParm, HasGetValueTypeHash)
	uint8                                        Pad_4EF1[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4EF2[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4EF3[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
