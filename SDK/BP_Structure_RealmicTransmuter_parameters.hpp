...
public:
	...
	uint8                                        Pad_6CC4[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_CraftInProgress           CraftingData;                                      // 0x10(0xD8)(Parm, OutParm, HasGetValueTypeHash)
	uint8                                        Pad_6CC5[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6CC8[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_CraftInProgress           CallFunc_Array_Get_Item_1;                         // 0x1F0(0xD8)(HasGetValueTypeHash)
	uint8                                        Pad_6CC9[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6CCB[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
