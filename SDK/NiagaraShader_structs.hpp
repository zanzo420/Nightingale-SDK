...
public:
	...
	uint8                                        BitPad_1D0 : 4;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_33FE[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3400[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3401[0x30];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3404[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
