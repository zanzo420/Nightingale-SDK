...
public:
	...
	uint8                                        Pad_5515[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_CraftInProgress           CallFunc_GetCurrentCraftData_ReturnValue;          // 0x260(0xD8)(HasGetValueTypeHash)
	uint8                                        Pad_5516[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5518[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_551A[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
