...
class UWBP_sw_RealmInfo_MinorCard_Entry_C : public UNWXUserWidget
{
public:
	...
	static class UWBP_sw_RealmInfo_MinorCard_Entry_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_WBP_sw_RealmInfo_MinorCard_Entry(int32 EntryPoint, bool CallFunc_TextIsEmpty_ReturnValue);
};
