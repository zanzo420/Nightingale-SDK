...
{
public:
	uint8                                        Pad_3BBF[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3BC0[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3BC1[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
