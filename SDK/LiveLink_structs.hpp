...
{
public:
	uint8                                        Pad_45B8[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_45B9[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_45BA[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
