...
{
public:
	uint8                                        Pad_3BEA[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3BEB[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3BEC[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
