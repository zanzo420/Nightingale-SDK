...
{
public:
	uint8                                        Pad_24C0[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_24C4[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_24C9[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
