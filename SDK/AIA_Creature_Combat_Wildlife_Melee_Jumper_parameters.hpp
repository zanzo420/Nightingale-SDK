...
struct UAIA_Creature_Combat_Wildlife_Melee_Jumper_C_OwnerMeleeRequirements_Params
{
public:
	bool                                         Success;                                           // 0x0(0x1)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_98AC[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_ActorHasTag_ReturnValue_4;                // 0x3F(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
