...
public:
	...
	uint8                                        Pad_2D65[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2D67[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2D6A[0x44];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2D6B[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
