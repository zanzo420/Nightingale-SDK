...
{
public:
	uint8                                        Pad_1C44[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C45[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1CBF[0x44];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1CC0[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
