...
public:
	...
	uint8                                        Pad_A72C[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGuid                                 CallFunc_Parse_StringToGuid_OutGuid;               // 0x38(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Parse_StringToGuid_Success;               // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A72F[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FEncounterDynamicData                 CallFunc_TryGetEncounterDynamicData_OutData;       // 0x50(0xB0)(None)
	bool                                         CallFunc_TryGetEncounterDynamicData_ReturnValue;   // 0x100(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_A734[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
