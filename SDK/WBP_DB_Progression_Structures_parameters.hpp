...
struct UWBP_DB_Progression_Structures_C_ExecuteUbergraph_WBP_DB_Progression_Structures_Params
{
public:
	...
	uint8                                        Pad_4D8A[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4D8C[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UStructureCheats*                      CallFunc_GetStructureCheatManager_ReturnValue;     // 0x58(0x8)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TMap<int32, struct FResourceDistributionList> CallFunc_GetResourceDistributionForStructures_OutResourceDistribution; // 0x60(0x50)(ContainsInstancedReference)
