...
class UAIA_Creature_Combat_NPCMelee_C : public UAIA_Creature_Combat_C
{
public:
	uint8                                        Pad_A856[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x170(0x8)(ZeroConstructor, Transient, DuplicateTransient)

	static class UClass* StaticClass();
	static class UAIA_Creature_Combat_NPCMelee_C* GetDefaultObj();
	...
	void ExecuteUbergraph_AIA_Creature_Combat_NPCMelee(int32 EntryPoint, class AActor* K2Node_Event_Target);
};
