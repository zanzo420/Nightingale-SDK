...
public:
	...
	float                                        HealthMaxOnStartStarving;                          // 0xF8(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        StaminaMaxOnStartTired;                            // 0xFC(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double GetMaxStaminaForTiredPercentage(double RestedPercentage, double CallFunc_Get_Tired_Threshold_Percentage_TiredThreshold, double CallFunc_MapRangeClamped_ReturnValue, double CallFunc_MapRangeClamped_OutRangeB_ImplicitCast);
	...
	double GetMaxHealthForFedPercentage(double FedPercentage, double CallFunc_Get_Starving_Threshold_Percentage_StarvingThreshold, double CallFunc_MapRangeClamped_ReturnValue, double CallFunc_MapRangeClamped_OutRangeB_ImplicitCast);
