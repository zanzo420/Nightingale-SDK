...
public:
	...
	uint8                                        Pad_3BE7[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3BE8[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3BE9[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        BitPad_21E : 6;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_3BF0[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
