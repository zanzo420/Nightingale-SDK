...
class UWBP_CC_DynamicSubPanel_Hair_Style_C : public UWBP_CC_DynamicSubPanel__Base_C
{
public:
	...
	uint8                                        Pad_7115[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FHairDataReference                    CachedData;                                        // 0x4B0(0x70)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UWBP_CC_DynamicSubPanel_Hair_Style_C* GetDefaultObj();

	class UWidget* BP_GetDesiredFocusTarget(class UWidget* CallFunc_BP_GetDesiredFocusTarget_ReturnValue);
	void UpdateActiveHair(const struct FHairDataReference& CallFunc_GetHairData_OutData, const struct FHairData& CallFunc_TryGetHairData_OutData, enum class EGetResult CallFunc_TryGetHairData_OutBranches, bool K2Node_SwitchEnum_CmpSuccess);
