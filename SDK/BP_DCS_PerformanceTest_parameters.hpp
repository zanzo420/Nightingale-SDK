...
struct UBP_DCS_PerformanceTest_C_CalculateAverages_Params
{
public:
	TArray<int32>                                AveragesCount;                                     // 0x0(0x10)(Edit, BlueprintVisible)
	...
	uint8                                        Pad_765[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	struct FStructure_DCS_PerfSample             CallFunc_Array_Get_Item_1;                         // 0x58(0x3C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                       CallFunc_FMod_Remainder;                           // 0xC0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_FMod_ReturnValue;                         // 0xC8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_Array_IsNotEmpty_ReturnValue;             // 0xE5(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
