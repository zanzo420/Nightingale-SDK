...
struct UWBP_sw_EmptyGridEntry_C_OnListItemObjectSet_Params
{
public:
...
struct UWBP_sw_EmptyGridEntry_C_OnInputMethodChanged_Params
{
public:
...
struct UWBP_sw_EmptyGridEntry_C_ExecuteUbergraph_WBP_sw_EmptyGridEntry_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_963B[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UObject*                               K2Node_Event_ListItemObject;                       // 0x8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	enum class ECommonInputType                  K2Node_Event_bNewInputType;                        // 0x10(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
