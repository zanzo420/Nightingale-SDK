...
{
public:
	uint8                                        Pad_40B3[0xC0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_40B4[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_40B5[0x9];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_40B6[0xC8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
