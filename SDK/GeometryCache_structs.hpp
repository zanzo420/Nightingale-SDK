...
{
public:
	uint8                                        Pad_BE2[0xC0];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_BE3[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_BE4[0x9];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_BE5[0xC8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
