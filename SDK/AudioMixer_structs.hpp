...
public:
	...
	uint8                                        Pad_2B47[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        BitPad_1C6 : 4;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_2B4A[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2B4E[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
