...
public:
	...
	void CalculateMissingSlots(TArray<struct FInventoryEntry>& SlottedIngredients, TArray<int32>* OutUnmetSlots, const struct FCraftingRecipe& CallFunc_GetCraftingRecipeData_ReturnValue, TArray<int32>& CallFunc_CraftingMenu_AllSlotsSatisfied_OutUnmetSlots);
};
