...
public:
	...
	uint8                                        Pad_489F[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_48A2[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_48A3[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_48A5[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
