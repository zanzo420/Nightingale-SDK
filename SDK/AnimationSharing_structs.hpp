...
public:
	...
	uint8                                        Pad_3376[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3379[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_337A[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_337C[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
