...
class UClass* UWBP_MenuDataEntryThumb_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_MenuDataEntryThumb_C");

	return Clss;
}


// WBP_MenuDataEntryThumb_C WBP_MenuDataEntryThumb.Default__WBP_MenuDataEntryThumb_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_MenuDataEntryThumb_C* UWBP_MenuDataEntryThumb_C::GetDefaultObj()
{
	static class UWBP_MenuDataEntryThumb_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_MenuDataEntryThumb_C*>(UWBP_MenuDataEntryThumb_C::StaticClass()->DefaultObject);
...
void UWBP_MenuDataEntryThumb_C::UnbindHudGoalTrackingEvent(class UBP_HUDGoalTrackingComponent_C* HudGoalTrackingComponent, class ANWXPlayerController* PlayerController, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsValid_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class UBP_HUDGoalTrackingComponent_C* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, class ANWXPlayerController* CallFunc_GetOwningPlayerController_ReturnValue)
{
	...
	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "UnbindHudGoalTrackingEvent");

	Params::UWBP_MenuDataEntryThumb_C_UnbindHudGoalTrackingEvent_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::BindHudGoalTrackingEvent(class UBP_HUDGoalTrackingComponent_C* HudGoalTrackingComponent, class ANWXPlayerController* PlayerController, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsObjectOfClass_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, bool CallFunc_IsObjectOfClass_ReturnValue_1, class UBP_HUDGoalTrackingComponent_C* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, class ANWXPlayerController* CallFunc_GetOwningPlayerController_ReturnValue)
{
	...
	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "BindHudGoalTrackingEvent");

	Params::UWBP_MenuDataEntryThumb_C_BindHudGoalTrackingEvent_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::RefreshNewState(bool HasNewState_IsObservable, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, enum class ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "RefreshNewState");

	Params::UWBP_MenuDataEntryThumb_C_RefreshNewState_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::UpdateTraitIcons(const TArray<class UStructureTraitCollectionAsset*>& LTraitCollections, const TArray<class UStructureTraitTypeUIData*>& LTraitTypes, const struct FVector2D& Temp_struct_Variable, class UStructureTraitCollectionAsset* CallFunc_Array_Get_Item, bool CallFunc_Array_IsValidIndex_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, class UStructureTraitCollectionAsset* CallFunc_Array_Get_Item_1, bool CallFunc_IsValid_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_3, bool CallFunc_Array_IsValidIndex_ReturnValue_1, class UWBP_sw_StructureTrait_C* CallFunc_Create_ReturnValue, const struct FMargin& K2Node_MakeStruct_Margin, class UWBP_sw_StructureTrait_C* CallFunc_Create_ReturnValue_1, const struct FMargin& K2Node_MakeStruct_Margin_1, class UPanelSlot* CallFunc_AddChild_ReturnValue, const struct FVector2D& Temp_struct_Variable_1, class UPanelSlot* CallFunc_AddChild_ReturnValue_1, class UBP_MenuDataEntry_Building_C* K2Node_DynamicCast_AsBP_Menu_Data_Entry_Building, bool K2Node_DynamicCast_bSuccess, TArray<class UStructureTraitCollectionAsset*>& CallFunc_GetTraitTypes_ReturnValue)
{
	...
	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "UpdateTraitIcons");

	Params::UWBP_MenuDataEntryThumb_C_UpdateTraitIcons_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::OnInventoryUpdated(TScriptInterface<class IItemContainer>& Source, struct FInventoryEntry& Item, int32 Quantity)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "OnInventoryUpdated");

	Params::UWBP_MenuDataEntryThumb_C_OnInventoryUpdated_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::UpdateCraftableCosmeticBox(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, class UBP_MenuDataEntry_Crafting_C* K2Node_DynamicCast_AsBP_Menu_Data_Entry_Crafting, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsCraftable_ReturnValue, enum class ESlateVisibility K2Node_Select_Default)
{
	...
	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "UpdateCraftableCosmeticBox");

	Params::UWBP_MenuDataEntryThumb_C_UpdateCraftableCosmeticBox_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::GetMenuDataEntry(class UNWXMenuDataEntry** Entry)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "GetMenuDataEntry");

	Params::UWBP_MenuDataEntryThumb_C_GetMenuDataEntry_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::UnbindFromEvents(class ANWXPlayerState* CallFunc_GetOwningPlayerState_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class UBP_InventoryComponent_C* CallFunc_GetLocalPlayerInventoryComponent_BPInventoryComponent, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, TScriptInterface<class IItemContainer> CallFunc_GetEssencePouch_Container, bool CallFunc_GetEssencePouch_ReturnValue, class UNWXMenuDataEntryObservedStateTracker* CallFunc_GetStateTracker_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UBP_InventoryComponent_C* CallFunc_GetLocalPlayerInventoryComponent_BPInventoryComponent_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_3, bool CallFunc_IsValid_ReturnValue_1, TScriptInterface<class IItemContainer> CallFunc_GetBackpack_Container, bool CallFunc_GetBackpack_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_4, bool CallFunc_IsValid_ReturnValue_2, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_5)
{
	...
	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "UnbindFromEvents");

	Params::UWBP_MenuDataEntryThumb_C_UnbindFromEvents_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::SetCardIcon(bool CallFunc_IsValidSoftObjectReference_ReturnValue, enum class EEntryProgressionStates CallFunc_GetState_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "SetCardIcon");

	Params::UWBP_MenuDataEntryThumb_C_SetCardIcon_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::TryInitializeCraftingEntry(FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsObjectOfClass_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class UBP_InventoryComponent_C* CallFunc_GetLocalPlayerInventoryComponent_BPInventoryComponent, TScriptInterface<class IItemContainer> CallFunc_GetEssencePouch_Container, bool CallFunc_GetEssencePouch_ReturnValue, class UBP_InventoryComponent_C* CallFunc_GetLocalPlayerInventoryComponent_BPInventoryComponent_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, bool CallFunc_IsValid_ReturnValue, TScriptInterface<class IItemContainer> CallFunc_GetBackpack_Container, bool CallFunc_GetBackpack_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_3)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "TryInitializeCraftingEntry");

	Params::UWBP_MenuDataEntryThumb_C_TryInitializeCraftingEntry_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::UpdateImage(enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, enum class ESlateVisibility Temp_byte_Variable_2, enum class ESlateVisibility Temp_byte_Variable_3, enum class EEntryProgressionStates Temp_byte_Variable_4, enum class ESlateVisibility Temp_byte_Variable_5, enum class ESlateVisibility Temp_byte_Variable_6, enum class ESlateVisibility Temp_byte_Variable_7, enum class ESlateVisibility Temp_byte_Variable_8, enum class EEntryProgressionStates Temp_byte_Variable_9, enum class ESlateVisibility Temp_byte_Variable_10, enum class ESlateVisibility Temp_byte_Variable_11, enum class ESlateVisibility Temp_byte_Variable_12, enum class ESlateVisibility Temp_byte_Variable_13, enum class EEntryProgressionStates Temp_byte_Variable_14, float Temp_real_Variable, float Temp_real_Variable_1, float Temp_real_Variable_2, float Temp_real_Variable_3, enum class EEntryProgressionStates Temp_byte_Variable_15, enum class EEntryProgressionStates CallFunc_GetState_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, enum class ESlateVisibility K2Node_Select_Default_1, enum class ESlateVisibility K2Node_Select_Default_2, enum class EEntryProgressionStates CallFunc_GetState_ReturnValue_1, float K2Node_Select_Default_3)
{
	...
	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "UpdateImage");

	Params::UWBP_MenuDataEntryThumb_C_UpdateImage_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::OnObservationStateChanged(bool IsObservable)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "OnObservationStateChanged");

	Params::UWBP_MenuDataEntryThumb_C_OnObservationStateChanged_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::CheckPinnedState(bool Temp_bool_Variable, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsPinned_ReturnValue, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, enum class ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "CheckPinnedState");

	Params::UWBP_MenuDataEntryThumb_C_CheckPinnedState_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::UpdateSelectedCosmetic(bool ShowOutline, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, enum class ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "UpdateSelectedCosmetic");

	Params::UWBP_MenuDataEntryThumb_C_UpdateSelectedCosmetic_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::OnThumbSelected(bool CallFunc_IsUnlocked_ReturnValue, class UNWXMenuDataEntryObservedStateTracker* CallFunc_GetStateTracker_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "OnThumbSelected");

	Params::UWBP_MenuDataEntryThumb_C_OnThumbSelected_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::CheckEntryUnlocked(struct FSkillDataReference& UnlockedSkill, class ANWXPlayerController* CallFunc_GetOwningPlayerController_ReturnValue, bool CallFunc_HasUserFocus_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_IsUnlocked_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "CheckEntryUnlocked");

	Params::UWBP_MenuDataEntryThumb_C_CheckEntryUnlocked_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::SetupGeneralCardCosmetics(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, bool Temp_bool_Variable_1, const struct FLinearColor& Temp_struct_Variable, const struct FLinearColor& Temp_struct_Variable_1, bool Temp_bool_Variable_2, const struct FLinearColor& Temp_struct_Variable_2, const struct FLinearColor& Temp_struct_Variable_3, enum class EEntryProgressionStates CallFunc_GetState_ReturnValue, bool CallFunc_IsUnlocked_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_CanViewDetails_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, class UNWXMenuDataEntryObservedStateTracker* CallFunc_GetStateTracker_ReturnValue, bool CallFunc_IsValid_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, bool CallFunc_IsObservable_ReturnValue, class FText CallFunc_GetDisplayName_ReturnValue, const struct FLinearColor& K2Node_Select_Default_1, const struct FLinearColor& K2Node_Select_Default_2)
{
	...
	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "SetupGeneralCardCosmetics");

	Params::UWBP_MenuDataEntryThumb_C_SetupGeneralCardCosmetics_Params Parms{};
...
struct FEventReply UWBP_MenuDataEntryThumb_C::OnInputConfirm(const struct FEventReply& CallFunc_Handled_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "OnInputConfirm");

	Params::UWBP_MenuDataEntryThumb_C_OnInputConfirm_Params Parms{};
...
struct FEventReply UWBP_MenuDataEntryThumb_C::OnMouseButtonDown_Border(const struct FGeometry& MyGeometry, struct FPointerEvent& MouseEvent, bool CallFunc_PointerEvent_IsMouseButtonDown_ReturnValue, const struct FEventReply& CallFunc_Unhandled_ReturnValue, const struct FEventReply& CallFunc_Handled_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "OnMouseButtonDown_Border");

	Params::UWBP_MenuDataEntryThumb_C_OnMouseButtonDown_Border_Params Parms{};
...
struct FEventReply UWBP_MenuDataEntryThumb_C::OnMouseDoubleClick_Border(const struct FGeometry& MyGeometry, struct FPointerEvent& MouseEvent, const struct FEventReply& CallFunc_Unhandled_ReturnValue, bool CallFunc_PointerEvent_IsMouseButtonDown_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, const struct FEventReply& CallFunc_Handled_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "OnMouseDoubleClick_Border");

	Params::UWBP_MenuDataEntryThumb_C_OnMouseDoubleClick_Border_Params Parms{};
...
class UWidget* UWBP_MenuDataEntryThumb_C::CreateTooltipWidget(class ANWXPlayerController* CallFunc_GetOwningPlayerController_ReturnValue, class ANWXPlayerController* CallFunc_GetOwningPlayerController_ReturnValue_1, class UWBP_GenericTooltip_C* CallFunc_Create_ReturnValue, class UWBP_GenericTooltip_C* CallFunc_Create_ReturnValue_1, class FText CallFunc_GetDisplayName_ReturnValue, bool CallFunc_IsUnlocked_ReturnValue, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, bool CallFunc_Not_PreBool_ReturnValue, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class FText CallFunc_Format_ReturnValue, class FText CallFunc_GetDisplayName_ReturnValue_1, bool CallFunc_CanViewDetails_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "CreateTooltipWidget");

	Params::UWBP_MenuDataEntryThumb_C_CreateTooltipWidget_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::BP_OnItemExpansionChanged(bool bIsExpanded)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "BP_OnItemExpansionChanged");

	Params::UWBP_MenuDataEntryThumb_C_BP_OnItemExpansionChanged_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::BP_OnItemSelectionChanged(bool bIsSelected)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "BP_OnItemSelectionChanged");

	Params::UWBP_MenuDataEntryThumb_C_BP_OnItemSelectionChanged_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::OnMouseEnter(const struct FGeometry& MyGeometry, struct FPointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "OnMouseEnter");

	Params::UWBP_MenuDataEntryThumb_C_OnMouseEnter_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::OnMouseLeave(struct FPointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "OnMouseLeave");

	Params::UWBP_MenuDataEntryThumb_C_OnMouseLeave_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::OnAddedToFocusPath(const struct FFocusEvent& InFocusEvent)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "OnAddedToFocusPath");

	Params::UWBP_MenuDataEntryThumb_C_OnAddedToFocusPath_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::OnRemovedFromFocusPath(const struct FFocusEvent& InFocusEvent)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "OnRemovedFromFocusPath");

	Params::UWBP_MenuDataEntryThumb_C_OnRemovedFromFocusPath_Params Parms{};
...
// Function WBP_MenuDataEntryThumb.WBP_MenuDataEntryThumb_C.Destruct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)
// Parameters:

void UWBP_MenuDataEntryThumb_C::Destruct()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "Destruct");
...
void UWBP_MenuDataEntryThumb_C::OnListItemObjectSet(class UObject* ListItemObject)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "OnListItemObjectSet");

	Params::UWBP_MenuDataEntryThumb_C_OnListItemObjectSet_Params Parms{};
...
// Function WBP_MenuDataEntryThumb.WBP_MenuDataEntryThumb_C.BP_OnEntryReleased
// (Event, Protected, BlueprintEvent)
// Parameters:

void UWBP_MenuDataEntryThumb_C::BP_OnEntryReleased()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "BP_OnEntryReleased");
...
// Function WBP_MenuDataEntryThumb.WBP_MenuDataEntryThumb_C.Construct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)
// Parameters:

void UWBP_MenuDataEntryThumb_C::Construct()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "Construct");
...
void UWBP_MenuDataEntryThumb_C::ExecuteUbergraph_WBP_MenuDataEntryThumb(int32 EntryPoint, const struct FGeometry& K2Node_Event_MyGeometry, const struct FPointerEvent& K2Node_Event_MouseEvent_1, const struct FPointerEvent& K2Node_Event_MouseEvent, const struct FFocusEvent& K2Node_Event_InFocusEvent_1, const struct FFocusEvent& K2Node_Event_InFocusEvent, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_GetImage_IsValidReference, TSoftObjectPtr<class UTexture2D> CallFunc_GetImage_EntryImage, class UObject* K2Node_Event_ListItemObject, class UNWXMenuDataEntry* K2Node_DynamicCast_AsNWXMenu_Data_Entry, bool K2Node_DynamicCast_bSuccess, class UNWXMenuDataEntryObservedStateTracker* CallFunc_GetStateTracker_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue, class ANWXPlayerState* CallFunc_GetOwningPlayerState_ReturnValue, bool K2Node_Event_bIsSelected, bool K2Node_Event_bIsExpanded)
{
	...
	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "ExecuteUbergraph_WBP_MenuDataEntryThumb");

	Params::UWBP_MenuDataEntryThumb_C_ExecuteUbergraph_WBP_MenuDataEntryThumb_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::ThumbLeftClicked__DelegateSignature(class UNWXMenuDataEntry* MenuDataEntry)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "ThumbLeftClicked__DelegateSignature");

	Params::UWBP_MenuDataEntryThumb_C_ThumbLeftClicked__DelegateSignature_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::ThumbRightClicked__DelegateSignature(class UNWXMenuDataEntry* MenuDataEntry)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "ThumbRightClicked__DelegateSignature");

	Params::UWBP_MenuDataEntryThumb_C_ThumbRightClicked__DelegateSignature_Params Parms{};
...
void UWBP_MenuDataEntryThumb_C::ThumbDoubleClick__DelegateSignature(class UNWXMenuDataEntry* MenuDataEntry)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_MenuDataEntryThumb_C", "ThumbDoubleClick__DelegateSignature");
