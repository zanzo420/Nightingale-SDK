...
class UWidget* UWBP_Guidebook_GridList_C::DoCustomNavigation(enum class EUINavigation Navigation)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_Guidebook_GridList_C", "DoCustomNavigation");

	Params::UWBP_Guidebook_GridList_C_DoCustomNavigation_Params Parms{};
...
// Function WBP_Guidebook_GridList.WBP_Guidebook_GridList_C.OnCustomNavigationStarted
// (Private, BlueprintCallable, BlueprintEvent)
// Parameters:

void UWBP_Guidebook_GridList_C::OnCustomNavigationStarted()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_Guidebook_GridList_C", "OnCustomNavigationStarted");
...
// class UWBP_BasicText_OneLine_C*    CallFunc_Create_ReturnValue_2                                    (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void UWBP_Guidebook_GridList_C::OnInputMethodChanged(enum class ECommonInputType CurrentInputType)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_Guidebook_GridList_C", "OnInputMethodChanged");

	Params::UWBP_Guidebook_GridList_C_OnInputMethodChanged_Params Parms{};
