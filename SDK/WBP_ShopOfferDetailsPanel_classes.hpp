...
public:
	...
	class UImage*                                ItemBG;                                            // 0x380(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                ItemPreviewImage;                                  // 0x388(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UOverlay*                              Overlay_DetailsBreakdownContainer;                 // 0x390(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_Common_Button_Base_C*             PurchaseButton;                                    // 0x398(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UCommonTextBlock*                      Txt_Itemname;                                      // 0x3A8(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTextBlock*                      Txt_ItemTypeLabel;                                 // 0x3B0(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTextBlock*                      Txt_NoPurchase;                                    // 0x3B8(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWidgetSwitcher*                       Ws_PurchaseButtonSwitcher;                         // 0x3C0(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWidgetSwitcher*                       Ws_RequirementsIndicator;                          // 0x3C8(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	TMap<enum class ETransactableType, class FText> TransactableToLocStringMap;                        // 0x3D0(0x50)(Edit, BlueprintVisible, DisableEditOnInstance)
	TMap<enum class EShopOfferPurchasableState, class FText> PurchasableStateToLocStringMap;                    // 0x420(0x50)(Edit, BlueprintVisible, DisableEditOnInstance)

	static class UClass* StaticClass();
	static class UWBP_ShopOfferDetailsPanel_C* GetDefaultObj();

	void SetOfferPreviewImage(class UNWXShopOfferListItem* Offer, const struct FVector2D& LRecipeSchematicImageSize, const struct FVector2D& LItemOfferImageSize, enum class ETransactableType Temp_byte_Variable, enum class ETransactableType Temp_byte_Variable_1, enum class ESlateVisibility Temp_byte_Variable_2, enum class ESlateVisibility Temp_byte_Variable_3, enum class ESlateVisibility Temp_byte_Variable_4, enum class ESlateVisibility Temp_byte_Variable_5, enum class ESlateVisibility Temp_byte_Variable_6, enum class ETransactableType CallFunc_GetTransactableType_ReturnValue, TSoftObjectPtr<class UTexture2D> CallFunc_GetIcon_ReturnValue, class UObject* CallFunc_LoadAsset_Blocking_ReturnValue, const struct FDeprecateSlateVector2D& K2Node_Select_Default, class UTexture2D* K2Node_DynamicCast_AsTexture_2D, bool K2Node_DynamicCast_bSuccess, const struct FSlateBrush& K2Node_MakeStruct_SlateBrush, enum class ESlateVisibility K2Node_Select_Default_1, const struct FDeprecateSlateVector2D& K2Node_Select_Schematic_ImplicitCast, const struct FDeprecateSlateVector2D& K2Node_Select_CraftingRecipe_ImplicitCast, const struct FDeprecateSlateVector2D& K2Node_Select_Unknown_ImplicitCast, const struct FDeprecateSlateVector2D& K2Node_Select_Item_ImplicitCast, const struct FDeprecateSlateVector2D& K2Node_Select_Emote_ImplicitCast);
	void OnHideOffer();
