...
public:
	...
	uint8                                        Pad_4CBF[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4CC1[0x178];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4CC4[0x768];                                   // Fixing Size Of Struct [ Dumper-7 ]
