...
struct UWBP_Horizontal_AutoScrollingText_C_SetText_Params
{
public:
...
struct UWBP_Horizontal_AutoScrollingText_C_InitializeMaxWIdthOverride_Params
{
public:
	...
	float                                        CallFunc_SetMaxDesiredWidth_InMaxDesiredWidth_ImplicitCast; // 0x4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x8 (0x8 - 0x0)
// Function WBP_Horizontal_AutoScrollingText.WBP_Horizontal_AutoScrollingText_C.InitializeWidthOverride
struct UWBP_Horizontal_AutoScrollingText_C_InitializeWidthOverride_Params
{
public:
	bool                                         CallFunc_Greater_DoubleDouble_ReturnValue;         // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UWBP_Horizontal_AutoScrollingText_C_PreConstruct_Params
{
public:
...
struct UWBP_Horizontal_AutoScrollingText_C_ExecuteUbergraph_WBP_Horizontal_AutoScrollingText_Params
{
public:
