...
public:
	...
	static class UAIA_Creature_Combat_Wildlife_Melee_Harpy_C* GetDefaultObj();
	...
	void ExecuteUbergraph_AIA_Creature_Combat_Wildlife_Melee_Harpy(int32 EntryPoint, const struct FGameplayTag& Temp_struct_Variable, const struct FGameplayTag& Temp_struct_Variable_1, class AActor* K2Node_Event_Target_1, class AActor* K2Node_Event_Target);
};
