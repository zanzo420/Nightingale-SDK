...
public:
	...
	struct FQuestTaskPresentationData            K2Node_MakeStruct_QuestTaskPresentationData;       // 0x1B8(0xB0)(None)
	bool                                         CallFunc_Array_IsNotEmpty_ReturnValue;             // 0x268(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5CF6[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FQuestTaskPresentationData            CallFunc_MakeCompoundTaskPresentationData_OutPresentationData; // 0x270(0xB0)(None)
	bool                                         CallFunc_MakeCompoundTaskPresentationData_ReturnValue; // 0x320(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
