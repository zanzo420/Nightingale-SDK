...
// 0x10 (0x10 - 0x0)
// Function WBP_sw_QuestTaskConditionEntry.WBP_sw_QuestTaskConditionEntry_C.GetTooltipWidget
struct UWBP_sw_QuestTaskConditionEntry_C_GetTooltipWidget_Params
{
public:
...
// 0xAA (0xAA - 0x0)
// Function WBP_sw_QuestTaskConditionEntry.WBP_sw_QuestTaskConditionEntry_C.ExecuteUbergraph_WBP_sw_QuestTaskConditionEntry
struct UWBP_sw_QuestTaskConditionEntry_C_ExecuteUbergraph_WBP_sw_QuestTaskConditionEntry_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ESlateVisibility                  Temp_byte_Variable;                                // 0x4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ESlateVisibility                  Temp_byte_Variable_1;                              // 0x5(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_73C0[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
