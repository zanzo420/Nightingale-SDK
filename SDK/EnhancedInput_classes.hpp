...
public:
	...
	uint8                                        Pad_37F7[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TMap<struct FGameplayTag, class UEnhancedPlayerMappableKeyProfile*> SavedKeyProfiles;                                  // 0x78(0x50)(Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                        Pad_380E[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_382B[0x1A0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_382D[0x1A0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_382E[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_382F[0x50];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3830[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3831[0x78];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3832[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3836[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3838[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_383C[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_383E[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3840[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
