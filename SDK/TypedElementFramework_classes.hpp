...
{
public:
	uint8                                        Pad_27E1[0x950];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_27E5[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_27E7[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
