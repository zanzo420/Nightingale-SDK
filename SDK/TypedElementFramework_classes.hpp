...
{
public:
	uint8                                        Pad_29A8[0x950];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_29B1[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_29B2[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_29B3[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
