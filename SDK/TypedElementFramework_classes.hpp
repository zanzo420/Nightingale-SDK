...
{
public:
	uint8                                        Pad_2D49[0x950];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2D51[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2D52[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2D53[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
