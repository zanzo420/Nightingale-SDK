...
{
public:
	uint8                                        Pad_2C18[0x950];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2C1D[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2C1F[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
