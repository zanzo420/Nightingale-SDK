...
{
public:
	uint8                                        Pad_1036[0x950];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1055[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1058[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
