...
struct UWBP_RealmMachine_CardDragVisual_C_ExecuteUbergraph_WBP_RealmMachine_CardDragVisual_Params
{
public:
	...
	class UWBP_RealmCard_C*                      CallFunc_Create_ReturnValue;                       // 0x10(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
