...
{
public:
	uint8                                        Pad_41B7[0x200];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_41B8[0x60];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_41BC[0x23];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_41BD[0x26];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_41BE[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
