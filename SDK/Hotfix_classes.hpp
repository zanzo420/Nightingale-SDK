...
{
public:
	uint8                                        Pad_3E3A[0x200];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3E3B[0x60];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3E3F[0x23];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3E40[0x26];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3E41[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
