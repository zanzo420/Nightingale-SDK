...
{
public:
	uint8                                        Pad_4045[0x200];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4046[0x60];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_404A[0x23];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_404B[0x26];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_404C[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
