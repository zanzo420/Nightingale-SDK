...
public:
	...
	uint8                                        Pad_2E2C[0x118];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2E2D[0x88];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2E2E[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2E2F[0xE0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
