...
public:
	...
	uint8                                        Pad_2B43[0x118];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2B44[0x88];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2B45[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2B46[0xE0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
