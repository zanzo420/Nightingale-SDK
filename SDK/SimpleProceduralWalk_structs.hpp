...
public:
	...
	uint8                                        Pad_29F0[0x118];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_29F1[0x88];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_29F3[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_29F4[0xE0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
