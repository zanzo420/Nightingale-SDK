...
public:
	...
	uint8                                        Pad_44D9[0x118];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_44DA[0x88];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_44DB[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_44DC[0xE0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
