...
public:
	...
	uint8                                        Pad_3090[0x118];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3091[0x88];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3092[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3093[0xE0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
