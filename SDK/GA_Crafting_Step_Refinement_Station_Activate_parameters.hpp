...
public:
	...
	uint8                                        Pad_5D15[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_5D1C[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_CraftInProgress           CallFunc_GetCraftForID_CraftInProgressData;        // 0x30(0xD8)(HasGetValueTypeHash)
	uint8                                        Pad_5D1D[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_5D42[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_CraftInProgress           CraftInProgressData;                               // 0x130(0xD8)(Edit, BlueprintVisible, HasGetValueTypeHash)
	uint8                                        Pad_5D43[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5D44[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5D47[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_CraftInProgress           CallFunc_GetCraftForID_CraftInProgressData;        // 0x260(0xD8)(HasGetValueTypeHash)
	uint8                                        Pad_5D48[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
