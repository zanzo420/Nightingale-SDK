...
public:
	...
	uint8                                        Pad_6508[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_CraftInProgress           CallFunc_GetCraftForID_CraftInProgressData;        // 0x10(0xD8)(HasGetValueTypeHash)
	uint8                                        Pad_6509[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_650C[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_CraftInProgress           CallFunc_GetCraftForID_CraftInProgressData;        // 0x30(0xD8)(HasGetValueTypeHash)
	uint8                                        Pad_650D[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_651B[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_6522[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_CraftInProgress           CraftInProgressData;                               // 0x130(0xD8)(Edit, BlueprintVisible, HasGetValueTypeHash)
	uint8                                        Pad_6523[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6529[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_CraftInProgress           CallFunc_GetCraftForID_CraftInProgressData;        // 0x260(0xD8)(HasGetValueTypeHash)
	uint8                                        Pad_652A[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_652C[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
