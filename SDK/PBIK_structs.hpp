...
{
public:
	uint8                                        Pad_1754[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	class FName                                  bone;                                              // 0x0(0x8)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1756[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1757[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
