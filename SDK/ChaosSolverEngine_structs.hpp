...
{
public:
	uint8                                        Pad_18B2[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_18B3[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_18B5[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
