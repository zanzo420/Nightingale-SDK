...
{
public:
	uint8                                        Pad_330D[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_330F[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3310[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
