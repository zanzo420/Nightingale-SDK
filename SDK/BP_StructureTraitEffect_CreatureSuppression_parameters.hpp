...
public:
	...
	uint8                                        Pad_A7A6[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A7A8[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class ANWXCreatureManagerBase*               LCreatureManager;                                  // 0x70(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x78(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A7AF[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A7B0[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A7B1[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
