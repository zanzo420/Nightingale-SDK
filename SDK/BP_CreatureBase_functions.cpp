...
void ABP_CreatureBase_C::GetCreatureName(class FText* CreatureName, bool CallFunc_IsValidRowHandle_IsValid, const struct FS_BPCreatureData& CallFunc_GetDataTableRowFromName_OutRow, bool CallFunc_GetDataTableRowFromName_ReturnValue, bool CallFunc_IsValid_ReturnValue, const struct FS_CreatureUIData& CallFunc_GetDataTableRowFromName_OutRow_1, bool CallFunc_GetDataTableRowFromName_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_CreatureBase_C", "GetCreatureName");

	Params::ABP_CreatureBase_C_GetCreatureName_Params Parms{};
