...
{
public:
	uint8                                        Pad_3A09[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3A13[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3A15[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3A16[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3A17[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3A18[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
