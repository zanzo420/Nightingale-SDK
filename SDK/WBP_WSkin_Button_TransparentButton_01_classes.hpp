...
class UWBP_WSkin_Button_TransparentButton_01_C : public UWBP_WidgetSkin_Base_Button_C
{
public:
	...
	static class UWBP_WSkin_Button_TransparentButton_01_C* GetDefaultObj();
