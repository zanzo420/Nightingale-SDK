...
struct UWBP_CC_AppearanceOptionEntry_C_OnInputMethodChanged_Params
{
public:
...
struct UWBP_CC_AppearanceOptionEntry_C_UpdateSelectedState_Params
{
public:
...
struct UWBP_CC_AppearanceOptionEntry_C_SelectEntry_Params
{
public:
...
struct UWBP_CC_AppearanceOptionEntry_C_Initialize_Params
{
public:
	...
	enum class ECommonInputType                  CallFunc_GetOwningPlayerInputType_ReturnValue;     // 0x18(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_IsValidRowHandle_IsValid;                 // 0x1B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UWBP_CC_AppearanceOptionEntry_C_BP_GetDesiredFocusTarget_Params
{
public:
...
struct UWBP_CC_AppearanceOptionEntry_C_Refresh_Params
{
public:
	...
	bool                                         CallFunc_DoesDataTableRowExist_ReturnValue;        // 0x4D1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValidSoftObjectReference_ReturnValue;   // 0x4D2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5282[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                CallFunc_Conv_TextToString_ReturnValue;            // 0x4D8(0x10)(ZeroConstructor, HasGetValueTypeHash)
	...
	enum class ESlateVisibility                  K2Node_Select_Default;                             // 0x4F0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5284[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        K2Node_Select_Default_1;                           // 0x4F4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0xF8 (0xF8 - 0x0)
// Function WBP_CC_AppearanceOptionEntry.WBP_CC_AppearanceOptionEntry_C.Get_BU_CC_Appearance_ToolTipWidget
struct UWBP_CC_AppearanceOptionEntry_C_Get_BU_CC_Appearance_ToolTipWidget_Params
{
public:
	class UWidget*                               ReturnValue;                                       // 0x0(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
struct UWBP_CC_AppearanceOptionEntry_C_CreateSaturateDMI_Params
{
public:
...
struct UWBP_CC_AppearanceOptionEntry_C_OnAddedToFocusPath_Params
{
public:
...
struct UWBP_CC_AppearanceOptionEntry_C_OnRemovedFromFocusPath_Params
{
public:
	struct FFocusEvent                           InFocusEvent;                                      // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
};
...
struct UWBP_CC_AppearanceOptionEntry_C_BndEvt__WBP_CC_AppearanceOptionEntry_CBU_Button_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature_Params
{
public:
...
struct UWBP_CC_AppearanceOptionEntry_C_ExecuteUbergraph_WBP_CC_AppearanceOptionEntry_Params
{
public:
	...
	bool                                         CallFunc_IsUsingGamepad_ReturnValue_1;             // 0x20(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsUsingGamepad_ReturnValue_2;             // 0x21(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x14 (0x14 - 0x0)
// Function WBP_CC_AppearanceOptionEntry.WBP_CC_AppearanceOptionEntry_C.AppearanceSelected__DelegateSignature
struct UWBP_CC_AppearanceOptionEntry_C_AppearanceSelected__DelegateSignature_Params
{
public:
