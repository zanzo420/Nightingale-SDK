...
public:
	...
	uint8                                        Pad_6239[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FMapPinData                           CallFunc_GetMapPinData_ReturnValue;                // 0x8(0xB0)(None)
	...
	TScriptInterface<class IBPI_HasTagContainer_C> K2Node_DynamicCast_AsBPI_Has_Tag_Container;        // 0xC0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_623E[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FGameplayTagContainer                 CallFunc_GetTagContainer_GameplayTagContainer;     // 0xD8(0x20)(None)
	bool                                         CallFunc_GetDiscoverableRadius_IsDiscoverable;     // 0xF8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_623F[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        CallFunc_GetDiscoverableRadius_Radius;             // 0xFC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class APlayerState*                          K2Node_ComponentBoundEvent_PlayerState;            // 0x100(0x8)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class ANWXPlayerState*                       K2Node_DynamicCast_AsNWXPlayer_State;              // 0x108(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TScriptInterface<class ILocationTrackerInterface> CallFunc_Server_AddMapPinData_self_CastInput;      // 0x118(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
