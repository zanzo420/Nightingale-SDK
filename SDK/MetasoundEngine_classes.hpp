...
{
public:
	uint8                                        Pad_4349[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4357[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4358[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TSet<struct FSoftObjectPath>                 ReferenceAssetClassCache;                          // 0x300(0x50)(Protected, NativeAccessSpecifierProtected)
	struct FGuid                                 AssetClassID;                                      // 0x350(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_435A[0x198];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4398[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
	...
	struct FMetaSoundNodeHandle AddNode(TScriptInterface<class IMetaSoundDocumentInterface>& NodeClass, enum class EMetaSoundBuilderResult* OutResult);
...
{
public:
	uint8                                        Pad_43AC[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_43AD[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_43AF[0xD4];                                    // Fixing Size Of Struct [ Dumper-7 ]
