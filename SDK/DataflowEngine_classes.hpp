...
{
public:
	uint8                                        Pad_2A77[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2A78[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2A79[0x28];                                    // Fixing Size After Last Property  [ Dumper-7 ]
