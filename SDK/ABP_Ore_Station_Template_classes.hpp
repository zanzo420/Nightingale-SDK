...
class UABP_Ore_Station_Template_C : public UNWXStructureAnimInstance
{
public:
	...
	uint8                                        Pad_A79B[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
