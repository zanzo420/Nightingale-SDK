...
public:
	...
	uint8                                        Pad_3F04[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3F11[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3F12[0x60];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3F14[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3F15[0x6F];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3F1E[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3F1F[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3F33[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3F3F[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
