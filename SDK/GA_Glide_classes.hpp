...
public:
	...
	void OnGlidingStopped(FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, TScriptInterface<class IGlidingInterface> CallFunc_UnbindDelegate_OnGlideStopped_self_CastInput, bool CallFunc_IsValid_ReturnValue);
