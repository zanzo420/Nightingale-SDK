...
struct UWBP_Crosshair_Default_C_ExecuteUbergraph_WBP_Crosshair_Default_Params
{
public:
	...
	TArray<class UWBP_CrosshairBase_C*>          CallFunc_GetAllWidgetsOfClass_FoundWidgets;        // 0x28(0x10)(ReferenceParm, ContainsInstancedReference)
	class UWBP_CrosshairBase_C*                  CallFunc_Array_Get_Item;                           // 0x38(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Array_Length_ReturnValue;                 // 0x40(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_8E80[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UWBP_CrosshairBase_C*                  CallFunc_Array_Get_Item_1;                         // 0x58(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_8E83[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
