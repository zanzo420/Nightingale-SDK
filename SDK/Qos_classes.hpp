...
{
public:
	uint8                                        Pad_ACE[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_ADC[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_AE8[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B15[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
