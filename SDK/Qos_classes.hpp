...
{
public:
	uint8                                        Pad_3BC3[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3BC5[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3BC7[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3BCB[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
