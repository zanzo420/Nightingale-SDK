...
public:
	...
	uint8                                        Pad_12B1[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_12B3[0xC0];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_12B5[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_12B6[0x17];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_12EF[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_12F2[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_12F6[0x28];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_12F7[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1313[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
