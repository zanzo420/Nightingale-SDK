...
struct UWBP_CC_DynamicSubPanel_ComingSoon_C_PreConstruct_Params
{
public:
...
struct UWBP_CC_DynamicSubPanel_ComingSoon_C_ExecuteUbergraph_WBP_CC_DynamicSubPanel_ComingSoon_Params
{
public:
	...
	float                                        CallFunc_SetHeightOverride_InHeightOverride_ImplicitCast; // 0x1C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
