...
// Function WBP_CC_DynamicSubPanel__Base.WBP_CC_DynamicSubPanel__Base_C.NavigatePrevious
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void UWBP_CC_DynamicSubPanel__Base_C::NavigatePrevious()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_CC_DynamicSubPanel__Base_C", "NavigatePrevious");
...
// Function WBP_CC_DynamicSubPanel__Base.WBP_CC_DynamicSubPanel__Base_C.NavigateNext
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void UWBP_CC_DynamicSubPanel__Base_C::NavigateNext()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_CC_DynamicSubPanel__Base_C", "NavigateNext");
...
// Function WBP_CC_DynamicSubPanel__Base.WBP_CC_DynamicSubPanel__Base_C.OnMouseWheel
...
struct FEventReply UWBP_CC_DynamicSubPanel__Base_C::OnMouseWheel(const struct FGeometry& MyGeometry, struct FPointerEvent& MouseEvent, const struct FEventReply& CallFunc_Handled_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_CC_DynamicSubPanel__Base_C", "OnMouseWheel");

	Params::UWBP_CC_DynamicSubPanel__Base_C_OnMouseWheel_Params Parms{};
