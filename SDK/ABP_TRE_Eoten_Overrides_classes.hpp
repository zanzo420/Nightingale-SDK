...
{
public:
	uint8                                        Pad_76EB[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace_1;             // 0x878(0x20)(None)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace_1;             // 0x898(0x20)(None)
	...
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone;                          // 0xD30(0x128)(None)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;               // 0xE58(0x20)(None)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;               // 0xE78(0x20)(None)
	struct FAnimNode_Root                        AnimGraphNode_Root_1;                              // 0xE98(0x20)(None)
	struct FAnimNode_LinkedInputPose             AnimGraphNode_LinkedInputPose;                     // 0xEB8(0xB8)(None)
	...
	uint8                                        Pad_76EC[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FRotator                              Rotation;                                          // 0xF98(0x18)(BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor)

	static class UClass* StaticClass();
	static class UABP_TRE_Eoten_Overrides_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ABP_TRE_Eoten_Overrides(int32 EntryPoint);
};
