...
class UClass* ABP_Structure_Functional_RainCollector_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Structure_Functional_RainCollector_C");

	return Clss;
}


// BP_Structure_Functional_RainCollector_C BP_Structure_Functional_RainCollector.Default__BP_Structure_Functional_RainCollector_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Structure_Functional_RainCollector_C* ABP_Structure_Functional_RainCollector_C::GetDefaultObj()
{
	static class ABP_Structure_Functional_RainCollector_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Structure_Functional_RainCollector_C*>(ABP_Structure_Functional_RainCollector_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Structure_Functional_RainCollector.BP_Structure_Functional_RainCollector_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ABP_Structure_Functional_RainCollector_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Structure_Functional_RainCollector_C", "ReceiveBeginPlay");
...
void ABP_Structure_Functional_RainCollector_C::ReceiveEndPlay(enum class EEndPlayReason EndPlayReason)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Structure_Functional_RainCollector_C", "ReceiveEndPlay");

	Params::ABP_Structure_Functional_RainCollector_C_ReceiveEndPlay_Params Parms{};
...
void ABP_Structure_Functional_RainCollector_C::WeatherStateChanged(int32 WeatherState)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Structure_Functional_RainCollector_C", "WeatherStateChanged");

	Params::ABP_Structure_Functional_RainCollector_C_WeatherStateChanged_Params Parms{};
