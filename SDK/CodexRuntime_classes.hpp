...
{
public:
	uint8                                        Pad_2EE1[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2EE5[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2EE8[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2EE9[0x48];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2EEB[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
