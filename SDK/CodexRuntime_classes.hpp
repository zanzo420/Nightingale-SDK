...
{
public:
	uint8                                        Pad_35C5[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_35D0[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_35D3[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_35D4[0x48];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FCodexEntryArraySerializer            GrantedCodices;                                    // 0x100(0x188)(Net, NativeAccessSpecifierPrivate)
	uint8                                        Pad_35D5[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_35D6[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
