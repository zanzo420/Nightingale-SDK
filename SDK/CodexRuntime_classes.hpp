...
{
public:
	uint8                                        Pad_311E[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_312A[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_312B[0x48];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_312E[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
