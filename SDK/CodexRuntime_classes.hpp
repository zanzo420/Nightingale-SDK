...
{
public:
	uint8                                        Pad_2184[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_218C[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_218E[0x48];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2190[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
