...
// 0xD90 (0x10D8 - 0x348)
// AnimBlueprintGeneratedClass ABP_HMB_Bound_Minion_Overrides.ABP_HMB_Bound_Minion_Overrides_C
class UABP_HMB_Bound_Minion_Overrides_C : public UAnimInstance
{
public:
	uint8                                        Pad_58C8[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace_1;             // 0x918(0x20)(None)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace_1;             // 0x938(0x20)(None)
	...
	struct FAnimNode_Root                        AnimGraphNode_Root_3;                              // 0xA30(0x20)(None)
	struct FAnimNode_LinkedInputPose             AnimGraphNode_LinkedInputPose_2;                   // 0xA50(0xB8)(None)
	struct FAnimNode_Root                        AnimGraphNode_Root_2;                              // 0xB08(0x20)(None)
	struct FAnimNode_LinkedInputPose             AnimGraphNode_LinkedInputPose_1;                   // 0xB28(0xB8)(None)
	struct FAnimNode_PowerIK_Ground              AnimGraphNode_PowerIK_Ground;                      // 0xBE0(0x3A0)(None)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;               // 0xF80(0x20)(None)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;               // 0xFA0(0x20)(None)
	struct FAnimNode_Root                        AnimGraphNode_Root_1;                              // 0xFC0(0x20)(None)
	struct FAnimNode_LinkedInputPose             AnimGraphNode_LinkedInputPose;                     // 0xFE0(0xB8)(None)
	struct FAnimNode_Root                        AnimGraphNode_Root;                                // 0x1098(0x20)(None)
	struct FRotator                              LookAtRot;                                         // 0x10B8(0x18)(BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor)
	double                                       LookAtAlpha;                                       // 0x10D0(0x8)(BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UABP_HMB_Bound_Minion_Overrides_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ABP_HMB_Bound_Minion_Overrides(int32 EntryPoint);
};
