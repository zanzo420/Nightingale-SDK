...
public:
	...
	uint8                                        Pad_1B18[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TSoftObjectPtr<class AWaterZone>             InWaterZoneOverride;                               // 0x0(0x28)(ConstParm, Parm, OutParm, ReferenceParm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_1B51[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1B82[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
