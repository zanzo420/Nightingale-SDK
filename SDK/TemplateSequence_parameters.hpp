...
public:
	...
	uint8                                        Pad_4866[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_486B[0xB];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	class APlayerController*                     PlayerController;                                  // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_486C[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	class APlayerController*                     PlayerController;                                  // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_486D[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMinimalViewInfo                      ReturnValue;                                       // 0x10(0x7C0)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
