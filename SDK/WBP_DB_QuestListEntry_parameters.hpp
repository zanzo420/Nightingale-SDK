...
{
public:
	struct FQuest                                QuestData;                                         // 0x0(0xA8)(BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference)
};
...
public:
	...
	uint8                                        Pad_6C25[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FQuest                                CallFunc_GetQuestDataFromQuestAssetReference_OutData; // 0x28(0xA8)(ContainsInstancedReference)
	bool                                         CallFunc_GetQuestDataFromQuestAssetReference_ReturnValue; // 0xD0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
