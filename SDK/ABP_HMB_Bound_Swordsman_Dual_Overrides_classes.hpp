...
class UABP_HMB_Bound_Swordsman_Dual_Overrides_C : public UAnimInstance
{
public:
	uint8                                        Pad_A4D4[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FAnimNode_Root                        AnimGraphNode_Root_2;                              // 0x878(0x20)(None)
	struct FAnimNode_LinkedInputPose             AnimGraphNode_LinkedInputPose_1;                   // 0x898(0xB8)(None)
	struct FAnimNode_PowerIK_Ground              AnimGraphNode_PowerIK_Ground;                      // 0x950(0x3A0)(None)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;               // 0xCF0(0x20)(None)
	...
	static class UABP_HMB_Bound_Swordsman_Dual_Overrides_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ABP_HMB_Bound_Swordsman_Dual_Overrides(int32 EntryPoint);
};
