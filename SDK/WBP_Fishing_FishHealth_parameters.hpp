...
struct UWBP_Fishing_FishHealth_C_SetIsReeling_Params
{
public:
...
struct UWBP_Fishing_FishHealth_C_InitializeFishBar_Params
{
public:
	...
	int64                                        CallFunc_Round64_ReturnValue;                      // 0xA0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                  CallFunc_Conv_Int64ToText_ReturnValue;             // 0xA8(0x18)(None)
	class ABP_FishingBobber_C*                   K2Node_DynamicCast_AsBP_Fishing_Bobber;            // 0xC0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
struct UWBP_Fishing_FishHealth_C_UpdateProgress_Params
{
public:
...
struct UWBP_Fishing_FishHealth_C_Tick_Params
{
public:
...
struct UWBP_Fishing_FishHealth_C_ExecuteUbergraph_WBP_Fishing_FishHealth_Params
{
public:
