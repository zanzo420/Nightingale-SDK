...
{
public:
	uint8                                        Pad_C7[0x8];                                       // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D6[0x5];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D8[0x10];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D9[0x8];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DF[0x40];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F0[0x10];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F1[0x10];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F2[0x90];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F3[0x78];                                      // Fixing Size Of Struct [ Dumper-7 ]
