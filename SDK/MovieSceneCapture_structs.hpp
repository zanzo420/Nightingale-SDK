...
public:
	...
	uint8                                        Pad_30B9[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_30BC[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_30BE[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
