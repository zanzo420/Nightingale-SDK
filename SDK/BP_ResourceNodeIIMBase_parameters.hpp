...
struct ABP_ResourceNodeIIMBase_C_OnDamageActor_Params
{
public:
...
struct ABP_ResourceNodeIIMBase_C_OnDamageReceived_Params
{
public:
	float                                        Damage;                                            // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_796B[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct ABP_ResourceNodeIIMBase_C_ExecuteUbergraph_BP_ResourceNodeIIMBase_Params
{
public:
