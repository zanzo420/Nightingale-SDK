...
{
public:
	uint8                                        Pad_A4BD[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FName                                  __NameProperty_36;                                 // 0x4(0x8)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A4BE[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A4BF[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A4C0[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A4C1[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
