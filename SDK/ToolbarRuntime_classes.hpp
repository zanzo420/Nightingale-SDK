...
{
public:
	uint8                                        Pad_4A0[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4B5[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4BA[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
