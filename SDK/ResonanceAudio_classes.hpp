...
public:
	...
	uint8                                        Pad_2A5A[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2A5B[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2A5C[0x98];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2A61[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
