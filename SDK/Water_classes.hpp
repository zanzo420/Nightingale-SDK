...
public:
	...
	uint8                                        Pad_1BE3[0x90];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1BE8[0x50];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1BE9[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1BEB[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1BF1[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1BF4[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	class UBodySetup*                            CachedBodySetup;                                   // 0x578(0x8)(ZeroConstructor, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_1BFD[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1C40[0x98];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C42[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1C5A[0x38];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C5B[0x28];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C5C[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1C66[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
