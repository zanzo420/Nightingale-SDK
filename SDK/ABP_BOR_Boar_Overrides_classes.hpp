...
class UABP_BOR_Boar_Overrides_C : public UAnimInstance
{
public:
	uint8                                        Pad_38E3[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FAnimNode_PowerIK_Ground              AnimGraphNode_PowerIK_Ground;                      // 0xE70(0x3A0)(None)
	...
	static class UABP_BOR_Boar_Overrides_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ABP_BOR_Boar_Overrides(int32 EntryPoint);
};
