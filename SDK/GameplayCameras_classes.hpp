...
public:
	...
	uint8                                        Pad_47A8[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_47A9[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_47CA[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_47CC[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_47D9[0x24];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_47DB[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_47DD[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_47DE[0x3C];                                    // Fixing Size Of Struct [ Dumper-7 ]
