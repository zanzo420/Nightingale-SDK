...
public:
	...
	uint8                                        Pad_46FE[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_46FF[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_470C[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4716[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_471F[0x24];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4720[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4721[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4729[0x3C];                                    // Fixing Size Of Struct [ Dumper-7 ]
