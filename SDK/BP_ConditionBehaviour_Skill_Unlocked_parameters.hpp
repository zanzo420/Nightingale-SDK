...
public:
	...
	uint8                                        Pad_A2B1[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FConditionPersistentData              CallFunc_MakeConditionPersistentDataFromBool_ReturnValue; // 0xE4(0x8)(NoDestructor)
	uint8                                        Pad_A2B2[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_A2B3[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
