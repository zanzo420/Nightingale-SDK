...
{
public:
	uint8                                        Pad_127[0x54];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_128[0xA8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_12B[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_12E[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_12F[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
