...
public:
	...
	uint8                                        Pad_3324[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3328[0xD];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_332A[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_332B[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FOngoingTaskProgress                  TaskProgress;                                      // 0x10(0xB0)(BlueprintVisible, BlueprintReadOnly, Parm)
...
public:
	...
	uint8                                        Pad_332E[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
