...
public:
	...
	uint8                                        Pad_1000[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1009[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1011[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1014[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1015[0xD];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	struct FFilterOptionPerAxis                  AxisFilter;                                        // 0xB0(0x3)(BlueprintVisible, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_1018[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_101A[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
