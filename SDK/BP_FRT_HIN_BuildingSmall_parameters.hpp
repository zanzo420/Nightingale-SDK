...
struct ABP_FRT_HIN_BuildingSmall_C_BndEvt__BP_FRT_HIN_BuildingSmall_AcousticVolume_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params
{
public:
	...
	uint8                                        Pad_A536[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct ABP_FRT_HIN_BuildingSmall_C_BndEvt__BP_FRT_HIN_BuildingSmall_AcousticVolume_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature_Params
{
public:
	class UPrimitiveComponent*                   OverlappedComponent;                               // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class AActor*                                OtherActor;                                        // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
struct ABP_FRT_HIN_BuildingSmall_C_ExecuteUbergraph_BP_FRT_HIN_BuildingSmall_Params
{
public:
