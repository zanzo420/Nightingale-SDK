...
{
public:
	uint8                                        Pad_37[0x68];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_38[0x80];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3A[0x8];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	struct FGuid                                 UniqueID;                                          // 0x38(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, NonPIEDuplicateTransient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
