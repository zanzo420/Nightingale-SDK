...
struct ABP_CreatureSpawner_Encounters_C_ExecuteUbergraph_BP_CreatureSpawner_Encounters_Params
{
public:
	...
	uint8                                        Pad_A6C0[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A6C5[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            CallFunc_Array_Random_OutItem;                     // 0x40(0x60)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
