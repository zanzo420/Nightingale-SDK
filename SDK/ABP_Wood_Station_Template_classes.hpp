...
class UABP_Wood_Station_Template_C : public UNWXStructureAnimInstance
{
public:
	...
	uint8                                        Pad_A79C[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
