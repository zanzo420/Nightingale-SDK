...
struct UWBP_Crosshair8_C_ExecuteUbergraph_WBP_Crosshair8_Params
{
public:
	...
	uint8                                        Pad_7F3C[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<class UWBP_CrosshairBase_C*>          CallFunc_GetAllWidgetsOfClass_FoundWidgets_1;      // 0x38(0x10)(ReferenceParm, ContainsInstancedReference)
	enum class EUMGSequencePlayMode              K2Node_Select_Default;                             // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_7F3D[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UWBP_CrosshairBase_C*                  CallFunc_Array_Get_Item_1;                         // 0x50(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
