...
class UABP_BOR_YoungBoar_Overrides_C : public UAnimInstance
{
public:
	uint8                                        Pad_9BAD[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class UABP_BOR_YoungBoar_Overrides_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ABP_BOR_YoungBoar_Overrides(int32 EntryPoint);
};
