...
{
public:
	uint8                                        Pad_4C93[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_4C94[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4C95[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
