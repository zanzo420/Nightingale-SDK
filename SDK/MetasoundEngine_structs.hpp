...
{
public:
	uint8                                        Pad_4B9F[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_4BA0[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4BA1[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
