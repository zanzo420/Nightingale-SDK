...
{
public:
	uint8                                        Pad_43C8[0x88];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_43C9[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_43CA[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_43CB[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
