...
{
public:
	uint8                                        Pad_3301[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3302[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3303[0xC0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3304[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_330A[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_330C[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
