...
public:
	...
	uint8                                        Pad_237C[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2387[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	class FText                                  OutText;                                           // 0x8(0x18)(Parm, OutParm, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x20(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_238D[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_23B5[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
