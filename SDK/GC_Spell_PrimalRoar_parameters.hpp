...
// 0xE3 (0xE3 - 0x0)
// Function GC_Spell_PrimalRoar.GC_Spell_PrimalRoar_C.OnRemove
struct AGC_Spell_PrimalRoar_C_OnRemove_Params
{
public:
...
// 0x111 (0x111 - 0x0)
// Function GC_Spell_PrimalRoar.GC_Spell_PrimalRoar_C.OnActive
struct AGC_Spell_PrimalRoar_C_OnActive_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                Parameters;                                        // 0x8(0xD8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
