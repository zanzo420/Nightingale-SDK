...
{
public:
	uint8                                        Pad_2973[0x128];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2974[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2976[0x190];                                   // Fixing Size Of Struct [ Dumper-7 ]
