...
{
public:
	uint8                                        Pad_2A5F[0x128];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2A61[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2A64[0x190];                                   // Fixing Size Of Struct [ Dumper-7 ]
