...
public:
	...
	uint8                                        Pad_D2[0x5];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D3[0x6];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DC[0x5];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DD[0x8];                                       // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_DF[0x38];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E4[0x8];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E6[0x17];                                      // Fixing Size Of Struct [ Dumper-7 ]
