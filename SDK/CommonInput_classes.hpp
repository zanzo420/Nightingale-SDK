...
public:
	...
	uint8                                        Pad_1C4[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1C9[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1CB[0x38];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1D0[0x17];                                     // Fixing Size Of Struct [ Dumper-7 ]
