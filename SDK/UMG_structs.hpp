...
{
public:
	uint8                                        Pad_12F7[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_12FB[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1305[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1318[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1319[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_131D[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_131E[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1322[0x590];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1325[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1326[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FSlateBrush                           Brush;                                             // 0x10(0xD0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TArray<class FString>                        Aliases;                                           // 0xE0(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
{
public:
	uint8                                        Pad_1328[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
