...
public:
	...
	bool MakeTaskPresentationData(struct FTask& Task, struct FConditionProgressDataList& TaskProgressList, struct FQuestTaskPresentationData* OutPresentationData, int32 CurrentValue, bool CallFunc_MakeTaskConditionPresentationData_bWasCreated, const struct FQuestTaskConditionPresentationData& CallFunc_MakeTaskConditionPresentationData_ConditionPresentationData, TArray<struct FQuestTaskConditionPresentationData>& K2Node_MakeArray_Array, const struct FQuestTaskPresentationData& K2Node_MakeStruct_QuestTaskPresentationData, bool CallFunc_Array_IsNotEmpty_ReturnValue, const struct FQuestTaskPresentationData& CallFunc_MakeCompoundTaskPresentationData_OutPresentationData, bool CallFunc_MakeCompoundTaskPresentationData_ReturnValue);
};
