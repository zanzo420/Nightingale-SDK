...
class UWBP_Popup_General_CustomPlayerText_C : public UNWXCommonWindowWidget
{
public:
	...
	static class UWBP_Popup_General_CustomPlayerText_C* GetDefaultObj();
	...
	void ExecuteUbergraph_WBP_Popup_General_CustomPlayerText(int32 EntryPoint, class UCommonButtonBase* K2Node_ComponentBoundEvent_Button_3, class UCommonButtonBase* K2Node_ComponentBoundEvent_Button_2, class UCommonButtonBase* K2Node_ComponentBoundEvent_Button_1, class UCommonButtonBase* K2Node_ComponentBoundEvent_Button);
