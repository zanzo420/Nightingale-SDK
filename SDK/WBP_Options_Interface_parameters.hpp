...
struct UWBP_Options_Interface_C_DoCustomNavigation_Params
{
public:
	...
	uint8                                        Pad_78FE[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7901[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7902[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7903[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7906[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7907[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct UWBP_Options_Interface_C_SetupNavigationWidgets_Params
{
public:
...
struct UWBP_Options_Interface_C_OnSubtitlesToggled_Params
{
public:
...
struct UWBP_Options_Interface_C_BP_GetDesiredFocusTarget_Params
{
public:
	...
	uint8                                        Pad_790B[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UWidget*                               CallFunc_GetDefaultFocusWidget_ReturnValue_1;      // 0x18(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};

// 0x10 (0x10 - 0x0)
// Function WBP_Options_Interface.WBP_Options_Interface_C.GetDefaultFocusWidget
struct UWBP_Options_Interface_C_GetDefaultFocusWidget_Params
{
public:
	class UWidget*                               ReturnValue;                                       // 0x0(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
struct UWBP_Options_Interface_C_OnLanguageChanged_Params
{
public:
	...
	uint8                                        Pad_790E[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                CallFunc_Array_Get_Item;                           // 0x28(0x10)(ZeroConstructor, HasGetValueTypeHash)
	int32                                        CallFunc_Array_Length_ReturnValue;                 // 0x38(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_SetCurrentCulture_ReturnValue;            // 0x3C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Less_IntInt_ReturnValue;                  // 0x3D(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_790F[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                CallFunc_GetSuitableCulture_ReturnValue;           // 0x40(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                CallFunc_GetCultureDisplayName_ReturnValue;        // 0x50(0x10)(ZeroConstructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_EqualEqual_StriStri_ReturnValue;          // 0xA0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x124 (0x124 - 0x0)
// Function WBP_Options_Interface.WBP_Options_Interface_C.InitializeWidgets
struct UWBP_Options_Interface_C_InitializeWidgets_Params
{
public:
	TArray<class FText>                          Languages;                                         // 0x0(0x10)(Edit, BlueprintVisible)
	...
	class FString                                CallFunc_Array_Get_Item;                           // 0x28(0x10)(ZeroConstructor, HasGetValueTypeHash)
	bool                                         CallFunc_GetShowSubtitles_ReturnValue;             // 0x38(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_7911[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7912[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                CallFunc_GetSuitableCulture_ReturnValue;           // 0x58(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                CallFunc_GetCultureDisplayName_ReturnValue;        // 0x68(0x10)(ZeroConstructor, HasGetValueTypeHash)
	TArray<class FString>                        CallFunc_GetLocalizedCultures_ReturnValue;         // 0x78(0x10)(ReferenceParm)
	...
	class FString                                CallFunc_GetCurrentLanguage_ReturnValue;           // 0xD0(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                CallFunc_GetCultureDisplayName_ReturnValue_1;      // 0xE0(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FText                                  CallFunc_Conv_StringToText_ReturnValue_1;          // 0xF0(0x18)(None)
	class FText                                  CallFunc_TextToUpper_ReturnValue_1;                // 0x108(0x18)(None)
...
struct UWBP_Options_Interface_C_ExecuteUbergraph_WBP_Options_Interface_Params
{
public:
	...
	TArray<class FText>                          K2Node_MakeArray_Array;                            // 0x8(0x10)(ConstParm, ReferenceParm)
