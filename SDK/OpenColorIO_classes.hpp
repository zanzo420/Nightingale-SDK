...
public:
	...
	uint8                                        Pad_3E7B[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3E7F[0xA0];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3E80[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3E82[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
