...
class UWBP_sw_RealmInfo_FactionEntry_C : public UNWXUserWidget
{
public:
	...
	static class UWBP_sw_RealmInfo_FactionEntry_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_WBP_sw_RealmInfo_FactionEntry(int32 EntryPoint);
};
