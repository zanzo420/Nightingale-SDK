...
// 0x5C (0x5C - 0x0)
// Function ANS_PaleDissolve.ANS_PaleDissolve_C.Received_NotifyEnd
struct UANS_PaleDissolve_C_Received_NotifyEnd_Params
{
public:
	...
	class ABP_Creature_Bound_C*                  K2Node_DynamicCast_AsBP_Creature_Bound;            // 0x50(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_IsServer_ReturnValue;                     // 0x5A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_BooleanAND_ReturnValue;                   // 0x5B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x72 (0x72 - 0x0)
// Function ANS_PaleDissolve.ANS_PaleDissolve_C.Received_NotifyBegin
struct UANS_PaleDissolve_C_Received_NotifyBegin_Params
{
public:
	class USkeletalMeshComponent*                MeshComp;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UAnimSequenceBase*                     Animation;                                         // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	float                                        TotalDuration;                                     // 0x10(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_8417[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class AActor*                                LOwner;                                            // 0x50(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_8419[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ABP_Creature_Bound_C*                  K2Node_DynamicCast_AsBP_Creature_Bound;            // 0x68(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
