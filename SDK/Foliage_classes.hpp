...
public:
	...
	uint8                                        Pad_E40[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        BitPad_7A : 5;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_EB6[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_ED7[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_EEF[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F0B[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F0E[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
