...
struct UEQC_PuckTarget_C_ProvideSingleActor_Params
{
public:
	...
	TArray<class APuckTarget_C*>                 CallFunc_GetAllActorsOfClass_OutActors;            // 0x18(0x10)(ReferenceParm)
	...
	uint8                                        Pad_A399[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
