...
public:
	...
	uint8                                        Pad_758F[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class UNWXShopOfferListPanelWidget*          CallFunc_GetShopOfferList_ReturnValue;             // 0x28(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UWBP_ShopOfferListPanel_C*             K2Node_DynamicCast_AsWBP_Shop_Offer_List_Panel;    // 0x30(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x38(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_7591[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UWidget*                               CallFunc_GetFirstScrollChild_Output;               // 0x40(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
