...
{
public:
	uint8                                        Pad_3870[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3876[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3878[0xB8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3879[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UChallengeDataAsset*>           PendingAdds;                                       // 0x178(0x10)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	uint8                                        Pad_387A[0x50];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_387B[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
