...
struct UWBP_HUD_Structure_TraitEntry_C_Get_img_trait_type_ToolTipWidget_Params
{
public:
...
struct UWBP_HUD_Structure_TraitEntry_C_InitNegativity_Params
{
public:
	bool                                         Temp_bool_Variable;                                // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_73C5[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct UWBP_HUD_Structure_TraitEntry_C_ExecuteUbergraph_WBP_HUD_Structure_TraitEntry_Params
{
public:
