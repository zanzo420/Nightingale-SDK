...
struct UWBP_cc_sw_Slider_2D_C_BP_GetDesiredFocusTarget_Params
{
public:
	...
	bool                                         CallFunc_GetIsExpandedCached_IsExpanded;           // 0xB(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UWBP_cc_sw_Slider_2D_C_OnInputMethodChanged_Params
{
public:
	...
	bool                                         CallFunc_GetIsExpandedCached_IsExpanded;           // 0x2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x3C (0x3C - 0x0)
// Function WBP_cc_sw_Slider_2D.WBP_cc_sw_Slider_2D_C.UpdateDragAudio
struct UWBP_cc_sw_Slider_2D_C_UpdateDragAudio_Params
{
public:
...
struct UWBP_cc_sw_Slider_2D_C_TriggerDragStopAudio_Params
{
public:
...
struct UWBP_cc_sw_Slider_2D_C_TriggerDragStartAudio_Params
{
public:
	FDelegateProperty_                           Temp_delegate_Variable;                            // 0x0(0x10)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UAkComponent*                          CallFunc_SpawnAkComponentAtLocation_ReturnValue;   // 0x10(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
struct UWBP_cc_sw_Slider_2D_C_ResetSlider_Params
{
public:
...
struct UWBP_cc_sw_Slider_2D_C_UpdateSliderVisuals_Params
{
public:
	struct FVector2D                             CallFunc_GetValue_ReturnValue;                     // 0x0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                       CallFunc_BreakVector2D_X;                          // 0x10(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UWBP_cc_sw_Slider_2D_C_Handle_2dSliderOnlyPresentation_Params
{
public:
...
struct UWBP_cc_sw_Slider_2D_C_Get_bu_Lock_ToolTipWidget_Params
{
public:
	class UWidget*                               ReturnValue;                                       // 0x0(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
struct UWBP_cc_sw_Slider_2D_C_Adjust_Section_Enabled_Visuals_Params
{
public:
	...
	uint8                                        Pad_7120[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct UWBP_cc_sw_Slider_2D_C_Get_bu_Reset_ToolTipWidget_Params
{
public:
	class UWidget*                               ReturnValue;                                       // 0x0(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class FText                                  Temp_text_Variable;                                // 0x8(0x18)(ConstParm)
...
struct UWBP_cc_sw_Slider_2D_C_RefreshSlider_Params
{
public:
	double                                       CallFunc_BreakVector2D_X;                          // 0x0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                       CallFunc_BreakVector2D_Y;                          // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UWBP_cc_sw_Slider_2D_C_Tick_Params
{
public:
...
struct UWBP_cc_sw_Slider_2D_C_OnAddedToFocusPath_Params
{
public:
...
struct UWBP_cc_sw_Slider_2D_C_OnRemovedFromFocusPath_Params
{
public:
	struct FFocusEvent                           InFocusEvent;                                      // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
};
...
struct UWBP_cc_sw_Slider_2D_C_BndEvt__WBP_cc_sw_Slider_2D_WBP_CC_SubWidget_Button_K2Node_ComponentBoundEvent_0_OnCategoryButtonExpansionSet__DelegateSignature_Params
{
public:
...
struct UWBP_cc_sw_Slider_2D_C_ExecuteUbergraph_WBP_cc_sw_Slider_2D_Params
{
public:
	...
	bool                                         CallFunc_IsUsingGamepad_ReturnValue;               // 0x65(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_7122[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_GetIsExpandedCached_IsExpanded;           // 0x79(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_7123[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UWidget*                               CallFunc_BP_GetDesiredFocusTarget_ReturnValue;     // 0x80(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Not_PreBool_ReturnValue;                  // 0x88(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_ComponentBoundEvent_IsExpanded;             // 0x89(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_GetIsExpandedCached_IsExpanded_1;         // 0x8C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsUsingGamepad_ReturnValue_1;             // 0x8D(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x10 (0x10 - 0x0)
// Function WBP_cc_sw_Slider_2D.WBP_cc_sw_Slider_2D_C.ED_SliderValueChanged__DelegateSignature
struct UWBP_cc_sw_Slider_2D_C_ED_SliderValueChanged__DelegateSignature_Params
{
public:
