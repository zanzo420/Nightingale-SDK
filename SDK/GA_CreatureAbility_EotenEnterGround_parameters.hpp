...
public:
	...
	uint8                                        Pad_9D3A[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_9D3C[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FGameplayTag                          Temp_struct_Variable_2;                            // 0x104(0x8)(ConstParm, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9D3D[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9D46[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
