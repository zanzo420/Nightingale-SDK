...
struct UWBP_HUD_ActivityLog_C_OnPlayerLeftParty_Params
{
public:
...
struct UWBP_HUD_ActivityLog_C_OnPlayerJoinedParty_Params
{
public:
	class FString                                PlayerName;                                        // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array;                            // 0x10(0x10)(ReferenceParm)
...
public:
	...
	uint8                                        Pad_943C[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_943D[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9443[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9445[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class UBP_PartyComponent_C*                  CallFunc_GetLocalPartyComponent_PartyComponent;    // 0x40(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_9448[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_944A[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
